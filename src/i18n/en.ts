export default {
    ...
    toolbox: {
        title: "My Toolbox",
        description: "Here is the list of technologies that I master.",
        items: [
            {
                title: "Frontend",
    ...
    mentorship: {
        ...
        description: "I offer courses to share my knowledge with your staff to improve the quality of your products.",
        items: [
            {
    ...
    services: {
        title: "What I offer",
        description: "A comprehensive range of services available for contract work, combining technical expertise with practical, scalable solutions.",
        items: [
            {
                title: "Frontend",
